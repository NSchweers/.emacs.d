...
** TODO Check whether this code is still buggy when km is a global variable instead of let-bound. 
#+BEGIN_SRC emacs-lisp
  (pc evil-org)

  ;;(let ((km (make-sparse-keymap)))
  ;;  (define-key km (kbd ",") 'org-edit-src-exit)
  ;;  (define-key km (kbd ".") 'org-edit-src-abort)
  ;;  (evil-define-key 'normal org-src-mode-map "," km))
#+END_SRC
