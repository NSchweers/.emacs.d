...
#+begin_src emacs-lisp
  (setf org-default-notes-file
        (expand-file-name ".emacs_data/notes.org" (getenv "HOME"))
...
own file.  I’ve convinced it to please not use the home directory for this.  The
rest of the configuration can be found in gnus.el.
