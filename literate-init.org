...
#+BEGIN_SRC emacs-lisp
  (define-advice lispy-newline-and-indent-plain (:around (orig) fix-inferior-scheme)
...
#+BEGIN_SRC elisp
  ...
  (define-advice occur (:after (regexp &optional nlines) schweers/occur-select-occur)
